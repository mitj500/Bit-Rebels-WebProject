	...
	if($_SERVER['REQUEST_METHOD'] == "POST")
	{
		...
		if(!empty($username) && !empty($password))
		{
            ...
            if(mysqli_num_rows(mysqli_query($con, $prequery))>0){
                ...
                $query = "insert into admin_credentials (USERNAME,PASSWORD,BUSINESS_NAME,EMAIL,ADDRESS,CONTACTNO) values ('$username','$password','$business_name','$email', '$address', '$contact')";
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form class="user" method="post">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" class="form-control form-control-user" id="exampleFirstName"
                                            ...
                                            <div id="alr-exists" style="color:red;">Username Taken</div>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <!-- <div id="error2" style="color:red;">Wrong Input</div> -->
