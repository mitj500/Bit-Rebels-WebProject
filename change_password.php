...
<html lang="en" dir="ltr">
  ...
  <body>
          ...
          <div class="row col col-md-6">
            ...
            <div class="row col col-md-12">
              <div class="col col-md-12 form-group">
                ...
                <input id="old_password" type="text" class="form-control" placeholder="old password" onblur="checkpass(this.value, 'old_password_error');">
    ...
    <script>
      function checkpass(password, err){
        var xhttp = new XMLHttpRequest();
  	    xhttp.onreadystatechange = function() {
  		if(xhttp.readyState = 4 && xhttp.status == 200){
  			document.getElementById("item_acknowledgement").innerHTML = xhttp.responseText;
        console.log(description + " " + category);
      }
  	};
  	xhttp.open("GET", "php/passthing.php?PASSWORD=" + password, true);
  	xhttp.send();
  }
    </script>
  </body>
