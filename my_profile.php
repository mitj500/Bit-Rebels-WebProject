          ...
          <div class="row col col-md-6">
            ...
            <div class="row col col-md-12">
              <div class="col col-md-12 form-group">
                ...
                <input id="business_name" type="text" class="form-control" value="<?php echo $business_name; ?>" placeholder="Business name" onkeyup="validateName(this.value, 'business_name_error');" disabled>
                <code class="text-danger small font-weight-bold float-right mb-2" id="business_name_error" style="display: none;"></code>
              </div>
            </div>
